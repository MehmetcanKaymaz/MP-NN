...
class Traj_Planer:
    def __init__(self):
        ...
        self.net.load_state_dict(torch.load("Traj-Models/checkpoint-1000.pth",map_location=torch.device('cpu')))
        self.net.eval() 

    def __conf_inputs(self,pose0,posef,vel0,velf):
        return [posef[0],posef[1],posef[2],posef[3],velf[0],velf[1],velf[3]]
